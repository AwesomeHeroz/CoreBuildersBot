...
val verifyShadowJar = tasks.register("verifyShadowJar") {
    ...
    doLast {
        ...
        val requiredEntries = listOf(
            ...
            "com/corebuilders/bot/service/MarketplaceDisputeOperations.class",
            ...
            "com/corebuilders/bot/web/MarketplaceImageStorage.class",
            "com/corebuilders/bot/web/MultipartFormData.class",
